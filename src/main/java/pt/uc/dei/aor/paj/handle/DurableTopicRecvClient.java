...
import pt.uc.dei.aor.paj.jms.StatsProducer;
...
public class DurableTopicRecvClient implements MessageListener
{
    ...
    public void onMessage(Message msg) {
     ...
     StatsProducer producer = new StatsProducer();
     producer.gotNewMessage(tmsg);     
    }
    ...
    public void listen() throws JMSException, NamingException, IOException{
        ...
        System.in.read();
        client.stop();
        System.out.println("Cliente de estatística terminado!");
